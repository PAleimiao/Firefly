...
![archinstall 主菜单](./images/01-main-menu.png)
...
![磁盘配置界面](./images/02-disk-config.png)
...
![确认安装界面](./images/04-confirm.png)

然后就去泡杯茶，等 5~20 分钟（看网速）。

![安装进度](./images/05-installing.png)

看到 `Installation completed without any errors!` 就是成了！

![安装完成](./images/06-complete.png)
