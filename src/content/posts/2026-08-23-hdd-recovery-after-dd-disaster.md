...
description: "朋友的朋友发来一行dd命令说是清理坏道，执行后硬盘直接被清零。这篇文章记录了整个事件的经过，以及机械硬盘和SSD的数据恢复方案。"
...
那天晚上，他在折腾一台瘦客户机（就是那种巴掌大的小主机），想改成低功耗下载机。他朋友看他折腾得热闹，发来一条消息：
...
终端开始输出进度，他还挺高兴，觉得朋友在帮他优化硬盘。过了大概两分钟，突然觉得不对劲——这进度条怎么一直在走？而且速度怎么这么快？
...
当场按 `Ctrl+C`，但已经晚了。两分钟的 `dd` 足够把分区表、引导记录、文件系统的关键区域全部抹成渣。

重启。黑屏。再重启。还是黑屏。

**那台瘦客户机，变成了一块价值几百元的砖头。**

然后他来找我说这个事，我听完血压都上来了。😂
...
把这类命令整理了一个黑名单，**看到任何一个，立刻停手，先查清楚再执行**：
...
最后，我想对那位"朋友的朋友"说：**请你朋友吃顿好的赔罪吧，至少两顿。** 😂
